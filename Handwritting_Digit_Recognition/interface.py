...
class Ui_MainWindow(object):
    ...
    def btRecog(self):
        ...
        # QtWidgets.QMessageBox.information(self.pushButton, "标题", "PyQt5 GUI程序")
    ...
    def btStop(self):
        ...
        self.textEdit.setText(self.textEdit.toPlainText() + "已停止（Stop）\n")
    ...
    def setupUi(self, MainWindow):
        ...
        self.trainThread = TrainThread()  # 实例化Thread（线程）类
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "基于tensoflow的手写数字识别系统"))
        ...
        self.label_2.setText(_translate("MainWindow", "  数字识别结果"))
